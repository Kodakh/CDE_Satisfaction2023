...
# Que fait le script ? Transformation avis + sous-cat
...
chemin_fichier_csv = '/home/jben/Desktop/ProjetDS/CDE_Satisfaction2023/data/raw/sql/details_entreprises_191223.csv'
...
df["Nombre d'avis"] = df["avis"].astype(int)
