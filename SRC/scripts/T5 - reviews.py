# Nature du processing : 
# 1. compilation de tous les commentaires dans 1 seul fichier .csv 
# 2. enlévement des caractères illégaux
# 3. ...
...
folder_path = r'CDE_Satisfaction2023/data/raw/coms'
...
# séparation de la ponctuation des mots
...
# Export processed
output_csv_path = os.path.join('CDE_Satisfaction2023/data/processed', 'L5_processed.csv')
